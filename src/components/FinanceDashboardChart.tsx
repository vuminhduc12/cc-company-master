...
export function FinanceDashboardChart({
  ...
  return (
    <div className={`min-w-0 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl ${accentGlow}`}>
      ...
      <div className="h-[310px] min-w-0 bg-[radial-gradient(circle_at_20%_0%,rgba(111,45,168,0.12),transparent_34%),linear-gradient(180deg,#111827,#0b1120)] p-2 sm:h-[390px] sm:p-4">
