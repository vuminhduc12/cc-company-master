  ...
  return (
    <section className="rounded-2xl border border-cyan-300/20 bg-slate-900/80 p-5 shadow-xl shadow-black/20 ring-1 ring-white/5">
      <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-start">
        ...
        <span className={auth.user ? "w-fit rounded-full border border-emerald-300/35 bg-emerald-300/10 px-3 py-1 text-xs font-black text-emerald-100" : "w-fit rounded-full border border-yellow-300/35 bg-yellow-300/10 px-3 py-1 text-xs font-black text-yellow-100"}>
          {auth.user ? "DB Sync Active" : "Local Mode"}
        </span>
      </div>
