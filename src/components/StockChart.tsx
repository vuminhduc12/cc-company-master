...
export function StockChart({ prices, ticker = "RGTI" }: { prices: DailyPrice[]; ticker?: string }) {
  ...
  return (
    <div className="min-w-0 overflow-hidden rounded-3xl border border-white/10 bg-[#0b1120] shadow-2xl shadow-black/30 ring-1 ring-white/5">
      ...
      <div className="px-3 pb-4 sm:px-5">
        <div className="h-[320px] min-w-0 overflow-hidden rounded-2xl border border-white/10 bg-[linear-gradient(180deg,#111827,#0b1120)] p-2 sm:h-[410px] sm:p-4">
